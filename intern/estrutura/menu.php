...
<html>
<head>
    <link rel="stylesheet" href="/pizz/conf/format/estiloMenu.css">
        ...
        <nav>
            <ul>
                <?php 
                    ...
                    echo  in_array($_SESSION["sessaoPerfil"], $menuCardapio) ? "<li><a href='/pizz/cardapio.php'><i class='fa-solid fa-table-columns'></i></i> Cardápio</a></li>" : "";
                ?>
            </ul>
        </nav>
	</div>
