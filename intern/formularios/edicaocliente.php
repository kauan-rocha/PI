        ...
        <div class="formCliente">
            ...
            <form action="/pizz/intern/formularios/operacaoform/editarcliente.php" method="GET">
                ...
                <span style="width: 20%;">
                    ...
                    <input type="text" maxlength="11" id="fedittel" name="fedittel" style="width: 90%; border: solid 1px;" disabled>
                </span>
                <span style="width: 55%;">
                    <label for="feditnome">Nome:</label>
                    <input type="text" id="feditnome" name="feditnome" style="width: 100%; border: solid 1px;" disabled>
                </span>
                ...
                <span style="width: 15%;">
                    ...
                    <input type="text" id="feditcep" name="feditcep" style="width: 90%; border: solid 1px;" disabled>
                </span>
                ...
                <span style="width: 12%;">
                    ...
                    <input type="text" id="feditnumero" name="feditnumero" style="width: 87%; border: solid 1px;" disabled>
                </span>
                ...
                <span style="width: 50%;">
                    ...
                    <input type="text" id="feditcomplemento" name="feditcomplemento" style="width: 96%; border: solid 1px;" disabled>
                </span>
